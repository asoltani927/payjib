<template>
  <!-- services  -->
  <div id="services" class="pt-10 pb-20 lg:py-8 lg:pt-[96px] lg:pb-[120px] lg:px-16">
    <BaseContainer>
        ...
        <div
          ...
          <div class="shrink-0 ms-6 lg:ms-0 w-[312px] lg:w-full flex flex-col">
            ...
            <p class="text-[#33373D] font-medium text-sm lg:text-lg mt-3">
              پی‌جیب پول‌ها را تا زمان تأیید کامل هر دو طرف نگه در حساب شرکتی
          ...
          <div class="shrink-0 w-[312px] lg:w-full flex flex-col">
            ...
            <p class="text-[#33373D] font-medium text-sm lg:text-lg mt-3">
              تمام کاربران پی‌جیب واقعی، با مدارک شناسایی و تائید شده هستن.
          ...
          <div class="shrink-0 w-[312px] lg:w-full me-6 lg:me-0 flex flex-col">
            ...
            <p class="text-[#33373D] font-medium text-sm lg:text-lg mt-3">
              هر قدم از تراکنش با اطلاع و تایید خودتون انجام میشه. ادمین‌های ما
              هم همیشه همراهتون هستن.
            </p>
          </div>
        </div>
      </div>
