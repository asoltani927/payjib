<template>
    ...
    <div class="w-full flex flex-col items-center gap-[53px] py-8 lg:py-[96px] px-6 lg:px-[139px] bg-white">
        <div @click="testClick" class="flex flex-col items-center gap-2">
        ...
        <div class="w-full flex flex-col items-center">
            <div v-for="(item, index) in questions" :key="index" class="w-full ">
                ...
                <!-- Answer -->
                <div v-show="index === isOpenAnswer" class="border-b-2 border-[#F0F2F5] text-[#33373D] text-[14px] lg:text-[16px] pb-6 px-6">
...
<script setup>
import { ref } from 'vue';
console.log('worked in script');
const testClick = () => {
  console.log('worked! with method')
}
