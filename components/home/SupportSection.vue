<template>
    <!-- support -->
    <div class="w-full  py-12 lg:py-[96px] px-6 lg:px-24 bg-[#f0f2f5]">
        <BaseContainer>
            <div class="flex flex-col lg:flex-row w-items-center justify-between lg:gap-[93px]">
                <div class="flex flex-col  items-center justify-center lg:items-start">
                    <span class="text-center lg:text-right font-black text-[32px] lg:text-[60px] text-[#2626BF]">همیشه
                        پاسخگوییم</span>
                    <span
                        class="hidden lg:block mt-2 mb-3 text-center lg:text-right text-[14px] lg:text-[28px] font-">پشتیبانان
