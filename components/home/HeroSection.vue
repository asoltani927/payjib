...
<template>
  ...
  <div class="bg-[#2626BF]">
    <div
      class="lg:px-24 items-center justify-between pb-12 lg:pb-[120px] gap-4 lg:gap-28 w-full h-full bg-[url(/home/img/home/hero-bg-2.png)] bg-cover bg-no-repeat pt-[70px] lg:pt-[185px]">
      <BaseContainer>
        <div class="flex flex-col lg:flex-row">
          <div class="lg:w-[45%] flex flex-col items-center lg:items-start text-[#E5E5E5]">
            <img class="mt-4 w-[129px] h-[74px] lg:w-[258px] lg:h-[149px]" src="/home/img/home/payjib-text.svg">
            <!-- <span>img</span> -->
            <div class="lg:text-3xl pb-8 lg:pb-0 text-center font-medium lg:text-start">
            ...
            <span class="hidden lg:flex mt-12 text-2xl font-medium"> از هر جای دنیا که هستید </span>
