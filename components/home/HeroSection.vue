    ...
    >
      <BaseContainer>
        <div class="flex flex-col lg:flex-row">
          <div
            class="lg:w-[45%] flex flex-col items-center lg:items-start text-[#E5E5E5]"
          >
            <img
              class="mt-4 w-[129px] h-[74px] lg:w-[258px] lg:h-[149px]"
              src="/home/img/home/payjib-text.svg"
            >
            <!-- <span>img</span> -->
            <div
              class="lg:text-3xl pb-8 lg:pb-0 text-center font-medium lg:text-start"
            >
              <h1 class="mb-2 lg:mb-4">
                تبادل، انتقال و حواله ارز راحت و سریع
              </h1>
            ...
            <span class="hidden lg:flex mt-12 text-2xl font-medium">
