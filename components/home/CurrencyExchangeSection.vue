    ...
    <div class="w-full bg-[#f0f2f5]">
        <BaseContainer>
            <div
                ...
                <nuxt-link v-for="(item, index) in countries" :key="`item-${index}`" :to="`/transfer-money-${item.slug}`"
                    class="flex lg:items-center gap-3.5 ">
                    <img class="w-6 h-6 lg:w-fit lg:h-auto transition-transform duration-[1000ms] ease-in-out"
