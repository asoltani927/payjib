...
<template>
  <Dialog
    ...
    class="!bg-[#2626BF] consultation-dialog pt-4 pb-2 px-2 rounded-none lg:rounded-3xl"
    modal
    :closable="false"
    dir="rtl"
  ...
  >
    <div class="flex flex-col-reverse lg:flex-row justify-between">
      <div class="flex flex-col lg:flex-row items-center gap-2">
        ...
        <span class="text-3xl lg:text-[40px] font-bold text-[#FFBF00]"
          >فرم درخواست مشاوره</span
        >
      </div>
      <div
        class="flex justify-end w-full lg:w-fit cursor-pointer"
        @click="visible = false"
      >
    ...
    <div
      class="w-full rounded-xl bg-white flex flex-col p-6 gap-4 mt-10 lg:mt-6"
    >
      ...
      >
        <div class="flex flex-col lg:flex-row items-center gap-4">
          <div
            class="w-full lg:w-fit flex-grow flex flex-col lg:flex-row items-center gap-4"
          >
